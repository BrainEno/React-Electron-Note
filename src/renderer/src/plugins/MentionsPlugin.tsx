...
const dummyLookupService = {
  search(string: string, callback: (result: Array<string>) => void): void {
    setTimeout(() => {
...
function NewMentionsPlugin(): JSX.Element | null {
  const [editor] = useLexicalComposerContext();

  const [queryString, setQueryString] = useState<string | null>();

  const results = useMentionLookupService(queryString as string);
